...
Source: "Daftar_Radiologi\MicrosoftEdgeWebview2Setup.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: FileExists('Daftar_Radiologi\MicrosoftEdgeWebview2Setup.exe')
